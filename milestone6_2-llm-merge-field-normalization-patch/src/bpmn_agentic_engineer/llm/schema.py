...
class LlmInterpretation:
    ...
    def from_dict(
        ...
        *,
        ...
        # Qwen can occasionally place the requested replacement label in
        # target_query for a sequence replacement. This correction is safe and
        # deterministic because target_query is not used by this operation.
        if (
            operation == "replace_linear_task_sequence"
            and not new_name
            and target_query
        ):
            new_name = target_query
            target_query = None
